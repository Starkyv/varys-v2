 ...
 *
 * The seam is the same one the `context` checkpoint already rides, which is the entire argument
 * for reusing it: a fake provider covers it for free, and a thrown transport
