...
export interface JudgeInput {
   ...
   *
   * Optional because the same seam also answers TEXT-ONLY questions — the assertion
   ...
   * here rather than needing a second provider (see the assertion fallback below).
   */
  system?: string;
  /**
